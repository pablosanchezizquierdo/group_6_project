...
selected_columns <- selected_columns %>%
  mutate(`Encoding Gene` = str_replace_all(tolower(selected_columns$`Encoding Gene`), setNames(unique_values_EcondingGene_clean$`Encoding Gene`, tolower(unique_values_EcondingGene_clean$`Encoding Gene`))))
selected_columns
?str_replace_all

#maybe you don't have to replace, just create a new column where if it finds a match writes the new gene code
```
