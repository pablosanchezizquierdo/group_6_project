...
weird_countries <- c("Brazil, Antarctic, Germany", "Chile-Peru Current Coastal","North Pond", "Eastern Africa Coastal Province")
selected_columns <- selected_columns |> 
...
selected_columns <- selected_columns |> 
  mutate(
    Continent = ifelse(is.na(Continent) & grepl("Ocean", Country),
                       Country,
                       Continent))

selected_columns <- selected_columns |> 
  mutate(Country = ifelse(grepl("Ocean", Country),
                     NA,
                     Country))
