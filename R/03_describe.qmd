...
#Save the plot
ggsave("../results/countries_vs_organisms_stacked_plot.png", plot4, width = 10, height = 6, dpi = 300)
```
...
only_bacteria_data$correct_continent[which(grepl("USA|Canada|Peru|Brazil|America|Venezuela|Panama|Mexico|Chile|Cananda|French Guiana", only_bacteria_data$Country))] <- "America"
...
#Save the plot
ggsave("../results/countries_and_continents_vs_organisms_stacked_plot.png", plot4, width = 10, height = 6, dpi = 300)
```
