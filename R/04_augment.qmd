...
Join both data frames using the Protein ID matches to incorporate the sequence column to the genes_clean data frame, creating a new data frame called data_augmented.
