...
![](healtyplanet.png){.absolute top="250" left="375" width="300" height="300"}
![](SuperBug.png){.absolute top="300" left="450" width="150" height="150"}
...
![](../results/compound_pathways_plot.png)
