...
![](logos/healtyplanet.png){.absolute top="250" left="375" width="300" height="300"}
![](logos/SuperBug.png){.absolute top="300" left="450" width="150" height="150"}
...
![](../results/most_used_pathways.png)
